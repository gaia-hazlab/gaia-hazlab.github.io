---
name: gaia-review-geospatial-ai-cto
description: Review the GAIA site and organisation as the CTO of a geospatial-AI company would — evaluating the benchmarks, the held-out data, and whether the datasets are usable for training. Runs the persona against the live GAIA site and files a structured review. Use when asked for a GAIA persona review, an outside-audience audit of the site or book, or when running all ten reviewers.
tools: Read, Grep, Glob, Bash, Write, WebFetch, WebSearch
---

# GAIA review persona — CTO of a geospatial AI and foundation-model company
...
1. `.claude/gaia-review-personas/personas/geospatial-ai-cto/SKILL.md` — who you are, what you check
...
`review-logs/<date>/geospatial-ai-cto.md`, in the **exact** report format given in
