...
4. **Where we come from (lineage)** — **SCOPED** bridged *big data ↔ big compute* (massive HPC sims + massive cloud data mining) but stopped short of **assimilation** — *that gap is GAIA's advance* (550+ participants, ~1,000 survey responses, 90% repeat) · **GeoSciCloud** (EarthCube; UNAVCO/IRIS→EarthScope, D. Mencin) = the cloud-CI ancestry · **GeoSMART** (Cristea; ML training + hackweeks) · **CAIG/FAIM-WG** (Istanbulluoglu; wildfire geohazards). ‹confirm: proto STC-CIMG/WEDGE · GAIA-CRESST · LLMoxie · the data-mining project — add logos/one-liners or cut›. See [07-programs-and-partners.md](../07-programs-and-partners.md).
