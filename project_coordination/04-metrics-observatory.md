...
```json
{
  ...
  "eval": {
    "source": "repere", "board_url": "https://mdenolle.github.io/repere",
...
Pulled by `collect_repere()` from the live [Repère board](https://mdenolle.github.io/repere/)
...
Observatory moved out, and the repository it was meant to move to was never created
(see [08 W5](08-site-remediation-plan.md), scheduled for end of Q4 2026). The archived
collector now carries the `collect_repere()` rename and is verified against the live board. This is the concrete
